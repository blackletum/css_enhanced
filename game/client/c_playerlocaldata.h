...
public:
	...
	CPlayerLocalData() :
		m_iv_vecPunchAngle( "CPlayerLocalData::m_iv_vecPunchAngle", &m_vecPunchAngle.GetForModify(), CIVLatchType::SIMULATION ),
		m_iv_vecPunchAngleVel( "CPlayerLocalData::m_iv_vecPunchAngleVel", &m_vecPunchAngleVel.GetForModify(), CIVLatchType::SIMULATION )
	{
		// m_iv_vecPunchAngle.Setup( &m_vecPunchAngle.m_Value, CIVLatchType::SIMULATION );
		// m_iv_vecPunchAngleVel.Setup( &m_vecPunchAngleVel.m_Value, CIVLatchType::SIMULATION );
		m_flFOVRate = 0;
	}
