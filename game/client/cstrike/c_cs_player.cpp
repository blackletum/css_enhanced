...
BEGIN_PREDICTION_DATA( C_CSPlayer )
	...
	DEFINE_FIELD( m_lastStandingPos, FIELD_VECTOR ),
	DEFINE_FIELD( m_ladderSurpressionTimer, FIELD_FLOAT ),
	DEFINE_FIELD( m_lastLadderPos, FIELD_VECTOR ),
	DEFINE_FIELD( m_lastLadderNormal, FIELD_VECTOR ),
